...
const Learn = () => {
  const menuItems = [
    ...
    { color: 'green', label: 'SRHR Laws', href: 'https://www.instructables.com/Basic-Street-Safety-for-Women/', icon: FaSwatchbook },
    { color: 'green', label: 'STI (with guidance from gynaecologist)', href: 'https://www.instructables.com/Basic-Street-Safety-for-Women/', icon: FaSwatchbook },
  ];
